...
const SchoolSelector = ({ onSelectSchool }) => {
  ...
  const schools = {
    ...
    'ㄴ': ['나사렛대', '남부대학교', '남서울대'],
    'ㄷ': ['단국대학교', '대구대학교' ,'대구가톨릭대', '대구경북과기원', '대구교대', '대구예대' , '대구한의대', '대신대학교',  '대전대학교', '대전가톨릭대', '대전신학대', '대진대학교', '덕성여대', '동국대학교', '동국대(와이즈)', '동덕여대','동명대학교','동서대학교','동신대학교','동아대학교','동양대학교','동의대학교']
    ,'ㄹ': ['루터대학교'] ,
    'ㅁ':['명지대학교','목원대학교','목포가톨릭대'],
    'ㅂ':['배재대학교',' 백석대학교',' 부산대학교',' 부산가톨릭대',' 부산교대',' 부산외대',
    '부산장신대'],
    'ㅅ':['삼육대학교', '상명대학교', '상지대학교','서강대학교','서경대학교','서울대학교','서울과학기술대','서울교대','서울기독대','서울시립대','서울신학대','서울여대','서울장신대','서울한영대','서원대학교','선문대학교','성결대학교','성공회대','성균관대','성신여대','세명대학교','세종대학교','세한대학교','송원대학교','수원대학교','수원가톨릭대','숙명여대','순천향대','숭실대학교','신경주대','신라대학교','신한대학교','서일대학교'],
