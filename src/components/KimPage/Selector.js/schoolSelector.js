...
const SchoolSelector = ({ onSelectSchool }) => {
  ...
  const schools = {
    ...
    'ㄱ': ['가야대학교','가천대학교','가톨릭관동대학교','가톨릭대학교','감리교신학대학교', '강남대학교', '강서대학교', '강원대학교' , '건국대학교', '건국대학교 GLOCAL캠퍼스', '건양대학교','경기대학교', '경남대학교','경동대학교','경북대학교', '경상국립대학교','경성대학교','경운대학교','경인교육대학교' ,'경일대학교','경주대학교', '경희대학교', '계명대학교' ,'고려대학교','고려대학교 세종캠퍼스', '고신대학교', '공군사관학교' ,'공주교육대학교','광신대학교' ,'광운대학교', '광주대학교', ],
    'ㄴ': ['나사렛대학교', '남부대학교', '남서울대학교'],
    'ㄷ': ['단국대학교', '대구대학교' ,'대구가톨릭대학교', '대구경북과학기술원', '대구교육대학교', '대구예술대학교' , '대구한의대학교', '대신대학교',  '대전대학교', '대전가톨릭대학교', '대전신학대학교', '대진대학교', '덕성여자대학교', '동국대학교', '동국대학교 WISE캠퍼스', '동덕여자대학교','동명대학교','동서대학교','동신대학교 ','동아대학교','동양대학교','동의대학교']
    ,'ㄹ': ['루터대학교'] ,
    ...
    'ㅍ':['평택대학교', '포항공과대학교'],
    'ㅎ':['한경국립대학교','한국공학대학교','한국과학기술원','한국교원대학교','한국기술교육대학교','한국방송통신대학교','한국성서대학교','한국예술종합학교','한국외국어대학교','한국전통문화대학교','한국체육대학교','한국침례신학대학교','한국항공대학교','한남대학교','한동대학교','한라대학교','한림대학교','한서대학교','한성대학교','한세대학교','한신대학교','한양대학교','한양대학교 ERICA캠퍼스','한일장신대학교','해군사관학교','협성대학교','호남대학교','호남신학대학교','호서대학교','호원대학교','홍익대학교','화성의과학대학교']
